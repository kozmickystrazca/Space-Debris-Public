...
# test passed if both english and slovak are working
if (is_language_working("en") and is_language_working("sk")):
    print("LANGUAGE TEST: " + bcolors.PASSED + "PASSED")
else:
    print("LANGUAGE TEST: " + bcolors.FAILED + "FAILED")
